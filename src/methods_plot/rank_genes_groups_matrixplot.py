...
def rank_genes_groups_matrixplot_plot():
    ...
    sc.pl.rank_genes_groups_matrixplot(
        ...
        values_to_plot=type_formater(kwargs["values_to_plot"],typing.Optional[typing.Literal['scores', 'logfoldchanges', 'pvals', 'pvals_adj', 'log10_pvals', 'log10_pvals_adj']]),
...
config.methods_plot["rank_genes_groups_matrixplot"] = dict(
    ...
    dict(
        input='Input', 
        name='values_to_plot', 
        description="typing.Optional[typing.Literal['scores', 'logfoldchanges', 'pvals', 'pvals_adj', 'log10_pvals', 'log10_pvals_adj']]", 
        visible=dict(function="str(None)!=config.active_plot_parameters['values_to_plot'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
