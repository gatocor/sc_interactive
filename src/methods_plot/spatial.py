...
def spatial_plot():
    ...
    sc.pl.spatial(
        ...
        na_color=type_formater(kwargs["na_color"],typing.Union[str, typing.Tuple[float, ...], str]),
        na_in_legend=type_formater(kwargs["na_in_legend"],bool),
        size=type_formater(kwargs["size"],float),
        ...
        library_id=type_formater(kwargs["library_id"],typing.Union[str, scanpy._utils.Empty]),
        crop_coord=type_formater(kwargs["crop_coord"],typing.Tuple[int, int, int, int]),
        alpha_img=type_formater(kwargs["alpha_img"],float),
        bw=type_formater(kwargs["bw"],typing.Optional[bool]),
        spot_size=type_formater(kwargs["spot_size"],typing.Optional[float]),
    )
...
config.methods_plot["spatial"] = dict(
    ...
    dict(
        input='Input', 
        name='na_color', 
        description="typing.Union[str, typing.Tuple[float, ...], str]", 
        visible=dict(function="str(None)!=config.active_plot_parameters['na_color'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
    ...
    dict(
        ...
        name='size', 
        description="<class 'float'>", 
        visible=dict(function="str(1.0)!=config.active_plot_parameters['size'] or config.show_plot"),
    ...
    dict(
        ...
        name='basis', 
        description="<class 'str'>", 
        visible=dict(function="'spatial'!=eval(config.active_plot_parameters['basis']) or config.show_plot"),
        properties=dict(value="'spatial'",type="text")
    ),
    dict(
        input='Input', 
        name='img', 
        description="typing.Optional[numpy.ndarray]", 
        visible=dict(function="str(None)!=config.active_plot_parameters['img'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='img_key', 
        description="typing.Union[str, str, scanpy._utils.Empty]", 
        visible=dict(function="str(Empty.token)!=config.active_plot_parameters['img_key'] or config.show_plot"),
        properties=dict(value="Empty.token",type="text")
    ),
    dict(
        input='Input', 
        name='library_id', 
        description="typing.Union[str, scanpy._utils.Empty]", 
        visible=dict(function="str(Empty.token)!=config.active_plot_parameters['library_id'] or config.show_plot"),
        properties=dict(value="Empty.token",type="text")
    ),
    dict(
        input='Input', 
        name='crop_coord', 
        description="typing.Tuple[int, int, int, int]", 
        visible=dict(function="str(None)!=config.active_plot_parameters['crop_coord'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='alpha_img', 
        description="<class 'float'>", 
        visible=dict(function="str(1.0)!=config.active_plot_parameters['alpha_img'] or config.show_plot"),
        properties=dict(value="1.0",type="text")
    ),
    dict(
        input='Input', 
        name='bw', 
        description="typing.Optional[bool]", 
        visible=dict(function="str(False)!=config.active_plot_parameters['bw'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),
    dict(
        input='Input', 
        name='spot_size', 
        description="typing.Optional[float]", 
        visible=dict(function="str(None)!=config.active_plot_parameters['spot_size'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),],
