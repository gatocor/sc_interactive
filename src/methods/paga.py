...
paga_args = dict(
    ...
    dict(
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['threshold'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
    ...
    dict(
        ...
        visible=dict(function="str({})!=config.active_node_parameters['layout_kwds'] or config.show_plot"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['init_pos'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(0)!=config.active_node_parameters['root'] or config.show_plot"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['labels'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=config.active_node_parameters['single_component'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="'connectivities'!=eval(config.active_node_parameters['solid_edges']) or config.show_plot"),
    ...
    dict(
        ...
        name='dashed_edges', 
        description="typing.Optional[str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['dashed_edges'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='transitions', 
        description="typing.Optional[str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['transitions'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['fontsize'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='fontweight', 
        description="<class 'str'>", 
        visible=dict(function="'bold'!=eval(config.active_node_parameters['fontweight']) or config.show_plot"),
    ...
    dict(
        ...
        name='fontoutline', 
        description="typing.Optional[int]", 
        visible=dict(function="str(None)!=config.active_node_parameters['fontoutline'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='text_kwds', 
        description="typing.Mapping[str, typing.Any]", 
        visible=dict(function="str({})!=config.active_node_parameters['text_kwds'] or config.show_plot"),
        properties=dict(value="{}",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(1.0)!=config.active_node_parameters['node_size_scale'] or config.show_plot"),
    ...
    dict(
        ...
        description="<class 'float'>", 
        visible=dict(function="str(0.5)!=config.active_node_parameters['node_size_power'] or config.show_plot"),
    ...
    dict(
        ...
        description="<class 'float'>", 
        visible=dict(function="str(1.0)!=config.active_node_parameters['edge_width_scale'] or config.show_plot"),
        properties=dict(value="1.0",type="text")
    ),
    dict(
        input='Input', 
        name='min_edge_width', 
        description="typing.Optional[float]", 
        visible=dict(function="str(None)!=config.active_node_parameters['min_edge_width'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='max_edge_width', 
        description="typing.Optional[float]", 
        visible=dict(function="str(None)!=config.active_node_parameters['max_edge_width'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(30)!=config.active_node_parameters['arrowsize'] or config.show_plot"),
    ...
    dict(
        ...
        name='left_margin', 
        description="<class 'float'>", 
        visible=dict(function="str(0.01)!=config.active_node_parameters['left_margin'] or config.show_plot"),
    ...
    dict(
        ...
        name='random_state', 
        description="typing.Optional[int]", 
        visible=dict(function="str(0)!=config.active_node_parameters['random_state'] or config.show_plot"),
        properties=dict(value="0",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['pos'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=config.active_node_parameters['normalize_to_color'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),
    dict(
        input='Input', 
    ...
    dict(
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['cax'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='cb_kwds', 
        description="typing.Mapping[str, typing.Any]", 
        visible=dict(function="str({})!=config.active_node_parameters['cb_kwds'] or config.show_plot"),
        properties=dict(value="{}",type="text")
    ),
    dict(
        input='Input', 
    ...
    dict(
        ...
        name='add_pos', 
        description="<class 'bool'>", 
        visible=dict(function="str(True)!=config.active_node_parameters['add_pos'] or config.show_plot"),
    ...
    dict(
        ...
        name='export_to_gexf', 
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=config.active_node_parameters['export_to_gexf'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),
    dict(
        input='Input', 
        name='use_raw', 
        description="<class 'bool'>", 
        visible=dict(function="str(True)!=config.active_node_parameters['use_raw'] or config.show_plot"),
        properties=dict(value="True",type="text")
    ),
    dict(
        input='Input', 
        name='plot', 
        description="<class 'bool'>", 
        visible=dict(function="str(True)!=config.active_node_parameters['plot'] or config.show_plot"),
        properties=dict(value="True",type="text")
    ),
    dict(
        input='Input', 
