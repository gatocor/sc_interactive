...
subsample_args = dict(
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['fraction']"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['n_obs']"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
