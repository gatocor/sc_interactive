...
recipe_weinreb17_args = dict(
    ...
    dict(
        ...
        visible=dict(function="str(0.01)!=get_node(config.selected)['data']['parameters']['mean_threshold']"),
    ...
    dict(
        ...
        visible=dict(function="str(2)!=get_node(config.selected)['data']['parameters']['cv_threshold']"),
    ...
    dict(
        ...
        name='n_pcs', 
        description="<class 'int'>", 
        visible=dict(function="str(50)!=get_node(config.selected)['data']['parameters']['n_pcs']"),
