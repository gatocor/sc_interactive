...
louvain_args = dict(
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['resolution']"),
    ...
    dict(
        ...
        visible=dict(function="'louvain'!=eval(get_node(config.selected)['data']['parameters']['key_added'])"),
    ...
    dict(
        ...
        visible=dict(function="'vtraag'!=eval(get_node(config.selected)['data']['parameters']['flavor'])"),
    ...
    dict(
        ...
        name='use_weights', 
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=get_node(config.selected)['data']['parameters']['use_weights']"),
    ...
    dict(
        ...
        visible=dict(function="str({})!=get_node(config.selected)['data']['parameters']['partition_kwargs']"),
