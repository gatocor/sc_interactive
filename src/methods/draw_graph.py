...
draw_graph_args = dict(
    ...
    dict(
        ...
        visible=dict(function="'fa'!=eval(get_node(config.selected)['data']['parameters']['layout'])"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['init_pos']"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['root']"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['key_added_ext']"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
