...
umap_args = dict(
    ...
    dict(
        ...
        visible=dict(function="str(0.5)!=get_node(config.selected)['data']['parameters']['min_dist'] or config.show_parameters"),
    ...
    dict(
        ...
        name='spread', 
        description="<class 'float'>", 
        visible=dict(function="str(1.0)!=get_node(config.selected)['data']['parameters']['spread'] or config.show_parameters"),
    ...
    dict(
        ...
        visible=dict(function="str(2)!=get_node(config.selected)['data']['parameters']['n_components'] or config.show_parameters"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['maxiter'] or config.show_parameters"),
    ...
    dict(
        ...
        name='alpha', 
        description="<class 'float'>", 
        visible=dict(function="str(1.0)!=get_node(config.selected)['data']['parameters']['alpha'] or config.show_parameters"),
        properties=dict(value="1.0",type="text")
    ),
    dict(
        input='Input', 
        name='gamma', 
        description="<class 'float'>", 
        visible=dict(function="str(1.0)!=get_node(config.selected)['data']['parameters']['gamma'] or config.show_parameters"),
        properties=dict(value="1.0",type="text")
    ),
    dict(
        input='Input', 
        ...
        description="<class 'int'>", 
        visible=dict(function="str(5)!=get_node(config.selected)['data']['parameters']['negative_sample_rate'] or config.show_parameters"),
    ...
    dict(
        ...
        visible=dict(function="'spectral'!=eval(get_node(config.selected)['data']['parameters']['init_pos']) or config.show_parameters"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['a'] or config.show_parameters"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='b', 
        description="typing.Optional[float]", 
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['b'] or config.show_parameters"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
