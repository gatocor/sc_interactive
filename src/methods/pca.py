...
pca_args = dict(
    ...
    dict(
        ...
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['n_comps'] or config.show_parameters"),
    ...
    dict(
        ...
        visible=dict(function="str(True)!=get_node(config.selected)['data']['parameters']['zero_center'] or config.show_parameters"),
    ...
    dict(
        ...
        visible=dict(function="'arpack'!=eval(get_node(config.selected)['data']['parameters']['svd_solver']) or config.show_parameters"),
    ...
    dict(
        ...
        visible=dict(function="str(False)!=get_node(config.selected)['data']['parameters']['return_info'] or config.show_parameters"),
    ...
    dict(
        ...
        description="typing.Optional[bool]", 
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['use_highly_variable'] or config.show_parameters"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='dtype', 
        description="<class 'str'>", 
        visible=dict(function="'float32'!=eval(get_node(config.selected)['data']['parameters']['dtype']) or config.show_parameters"),
    ...
    dict(
        ...
        name='chunked', 
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=get_node(config.selected)['data']['parameters']['chunked'] or config.show_parameters"),
        properties=dict(value="False",type="text")
    ),
    dict(
        input='Input', 
        name='chunk_size', 
        description="typing.Optional[int]", 
        visible=dict(function="str(None)!=get_node(config.selected)['data']['parameters']['chunk_size'] or config.show_parameters"),
        properties=dict(value="None",type="text")
    ),],
    postexecution = [],
    plot = [
    ...
    dict(
        ...
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=get_node(config.selected)['data']['plot']['annotate_var_explained'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),]
)
