...
pca_args = dict(
    ...
    dict(
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['color'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['gene_symbols'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='use_raw', 
        description="typing.Optional[bool]", 
        visible=dict(function="str(None)!=config.active_node_parameters['use_raw'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='sort_order', 
        description="<class 'bool'>", 
        visible=dict(function="str(True)!=config.active_node_parameters['sort_order'] or config.show_plot"),
        properties=dict(value="True",type="text")
    ),
    dict(
        input='Input', 
        name='edges', 
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=config.active_node_parameters['edges'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(0.1)!=config.active_node_parameters['edges_width'] or config.show_plot"),
    ...
    dict(
        ...
        visible=dict(function="'grey'!=eval(config.active_node_parameters['edges_color']) or config.show_plot"),
    ...
    dict(
        ...
        name='neighbors_key', 
        description="typing.Optional[str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['neighbors_key'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='arrows', 
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=config.active_node_parameters['arrows'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['arrows_kwds'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='groups', 
        description="typing.Optional[str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['groups'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['components'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['dimensions'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='layer', 
        description="typing.Optional[str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['layer'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="'2d'!=eval(config.active_node_parameters['projection']) or config.show_plot"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['scale_factor'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
    ...
    dict(
        ...
        name='cmap', 
        description="typing.Union[matplotlib.colors.Colormap, str, str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['cmap'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
    ...
    dict(
        ...
        visible=dict(function="'lightgray'!=eval(config.active_node_parameters['na_color']) or config.show_plot"),
    ...
    dict(
        ...
        name='na_in_legend', 
        description="<class 'bool'>", 
        visible=dict(function="str(True)!=config.active_node_parameters['na_in_legend'] or config.show_plot"),
        properties=dict(value="True",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['size'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='frameon', 
        description="typing.Optional[bool]", 
        visible=dict(function="str(None)!=config.active_node_parameters['frameon'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['legend_fontsize'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="'bold'!=eval(config.active_node_parameters['legend_fontweight']) or config.show_plot"),
    ...
    dict(
        ...
        name='legend_loc', 
        description="<class 'str'>", 
        visible=dict(function="'right margin'!=eval(config.active_node_parameters['legend_loc']) or config.show_plot"),
    ...
    dict(
        ...
        description="typing.Optional[int]", 
        visible=dict(function="str(None)!=config.active_node_parameters['legend_fontoutline'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='colorbar_loc', 
        description="typing.Optional[str]", 
        visible=dict(function="'right'!=eval(config.active_node_parameters['colorbar_loc']) or config.show_plot"),
    ...
    dict(
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['vmax'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='vmin', 
        description="typing.Union[str, float, typing.Callable[[typing.Sequence[float]], float], typing.Sequence[typing.Union[str, float, typing.Callable[[typing.Sequence[float]], float]]], str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['vmin'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='vcenter', 
        description="typing.Union[str, float, typing.Callable[[typing.Sequence[float]], float], typing.Sequence[typing.Union[str, float, typing.Callable[[typing.Sequence[float]], float]]], str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['vcenter'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['norm'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='add_outline', 
        description="typing.Optional[bool]", 
        visible=dict(function="str(False)!=config.active_node_parameters['add_outline'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),
    dict(
        input='Input', 
        ...
        visible=dict(function="str((0.3, 0.05))!=config.active_node_parameters['outline_width'] or config.show_plot"),
    ...
    dict(
        ...
        visible=dict(function="str(('black', 'white'))!=config.active_node_parameters['outline_color'] or config.show_plot"),
    ...
    dict(
        ...
        visible=dict(function="str(4)!=config.active_node_parameters['ncols'] or config.show_plot"),
    ...
    dict(
        ...
        name='hspace', 
        description="<class 'float'>", 
        visible=dict(function="str(0.25)!=config.active_node_parameters['hspace'] or config.show_plot"),
    ...
    dict(
        ...
        name='wspace', 
        description="typing.Optional[float]", 
        visible=dict(function="str(None)!=config.active_node_parameters['wspace'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='title', 
        description="typing.Union[str, typing.Sequence[str], str]", 
        visible=dict(function="str(None)!=config.active_node_parameters['title'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
    ...
    dict(
        ...
        visible=dict(function="str(None)!=config.active_node_parameters['ax'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        name='return_fig', 
        description="typing.Optional[bool]", 
        visible=dict(function="str(None)!=config.active_node_parameters['return_fig'] or config.show_plot"),
        properties=dict(value="None",type="text")
    ),
    dict(
        input='Input', 
        ...
        description="<class 'bool'>", 
        visible=dict(function="str(False)!=config.active_node_parameters['annotate_var_explained'] or config.show_plot"),
        properties=dict(value="False",type="text")
    ),]
)
